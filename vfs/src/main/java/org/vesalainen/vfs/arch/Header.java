...
public abstract class Header extends FileAttributeAccessStore
{
    ...
    public abstract void store(SeekableByteChannel channel, String filename, FileFormat format, String linkname, Map<String,Object> attributes) throws IOException;
