 ...
 */
public class FaxDecoder0 extends JavaLogging implements FaxStateListener
{
    private int lpm;
    private int ioc;
    private Path in;
    ...
    public FaxDecoder0(int lpm, int ioc, Path in, Path out) throws MalformedURLException
    {
        super(FaxDecoder0.class);
        try
        {
            this.lpm = lpm;
            this.ioc = ioc;
