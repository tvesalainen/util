 ...
 */
public abstract class AbstractCoordinateMap<V> extends TreeMap2D<Integer,Integer,V>
{
    ...
    public AbstractCoordinateMap(double latitude, double boxSize, UnitType unit)
    {
    ...
    protected abstract V itemCreator(double k1, double k2);
