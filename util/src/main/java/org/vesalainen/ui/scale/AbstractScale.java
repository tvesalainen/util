...
public abstract class AbstractScale implements Scale
{
    ...
    protected AbstractScale(MathFunction function)
    {
    ...
    protected class AbstractScaleLevel implements ScaleLevel
    {
         ...
         */
        @Override
        public void forEach(double min, double max, Locale locale, ScalerOperator op)
        {
        ...
        {
            formatter.format(format, function.applyAsDouble(value));
        }
        ...
        {
            return new Iter(function.applyAsDouble(min), function.applyAsDouble(max));
        }
        private class Iter implements PrimitiveIterator.OfDouble
        {
            ...
            public double nextDouble()
            {
                ...
                double res = next;
                next += step;
                return inverse.applyAsDouble(res);
            }
