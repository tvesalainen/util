...
public class ImageAreaFiller extends AreaFiller
{
    ...
    public ImageAreaFiller(BufferedImage image)
    {
    ...
    @Override
    public void fill(int minX, int minY, int maxX, int maxY, IntBiPredicate target, int replacement)
    {
        this.offset = minX;
        this.length = maxX-minX;
        super.fill(minX, minY, maxX, maxY, target, replacement);
    }
    ...
    public void fill(int minX, int minY, int maxX, int maxY, IntBiPredicate isInside, IntBinaryOperator pattern)
    {
        this.offset = minX;
        this.length = maxX-minX;
        super.fill(minX, minY, maxX, maxY, isInside, pattern);
    }
