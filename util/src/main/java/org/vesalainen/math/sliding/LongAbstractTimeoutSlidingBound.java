...
public abstract class LongAbstractTimeoutSlidingBound extends LongAbstractSlidingBound implements Timeouting, TimeArray
{
     ...
     */
    protected LongAbstractTimeoutSlidingBound(int initialSize, long timeout)
    {
     ...
     * @param timeout Sample timeout in millis.
     */
    protected LongAbstractTimeoutSlidingBound(LongSupplier clock, int initialSize, long timeout)
    {
        super(initialSize);
        this.clock = clock;
     ...
     * @param parent
     */
    LongAbstractTimeoutSlidingBound(Timeouting parent)
    {
