...
/**
 * BinarySet is similar to TreeSet. It is backed with ArrayList and it uses
 binary-get for set behavior. BinarySet has extra method get which can
...
public class BinarySet<E> extends AbstractSet<E> implements NavigableSet<E>
{
    ...
    public BinarySet(SortedSet<E> set)
    {
        this();
    ...
    public BinarySet(Comparator<? super E> comparator, List<E> list, boolean reverse)
    {
        if (reverse)
        {
    ...
    public NavigableSet<E> tailSet(E fromElement, boolean inclusive)
    {
        ...
        return new BinarySet(comparator, list.subList(low, list.size()), false);
    }
    /**
     * {@inheritDoc}
     * @return 
    ...
    {
        return new BinarySet(comparator, list, true);
    }
    /**
     * {@inheritDoc}
     * @return 
