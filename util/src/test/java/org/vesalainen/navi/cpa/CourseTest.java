...
public class CourseTest
{
    ...
    public void testGenerate()
    {
        ...
        Polynom x1 = b.create("λ"+sub0+"+"+"cos(φ)"+inv1+"sin(α"+sub0+")*s"+sub0+"*t");
        Polynom y1 = b.create("φ"+sub0+"+"+"cos(α"+sub0+")*s"+sub0+"*t");
        Polynom x2 = b.create("λ"+sub1+"+"+"cos(φ)"+inv1+"sin(α"+sub1+")*s"+sub1+"*t");
        Polynom y2 = b.create("φ"+sub1+"+"+"cos(α"+sub1+")*s"+sub1+"*t");
        Polynom dep = b.create("cos(φ)");
        Polynom dx = b.minus(x1, x2);
        Polynom dxx = b.mul(dep, dx);
        Polynom dy = b.minus(y1, y2);
        Polynom dx2 = b.mul(dxx, dxx);
