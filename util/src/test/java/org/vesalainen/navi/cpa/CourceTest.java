...
public class CourceTest
{
    ...
    {
        SimpleCource c1 = new SimpleCource(-1, 0, 1, 0);
        assertEquals(0, c1.getLatitudeAt(HOURS.toMillis(60)), 1e-10);
        SimpleCource c2 = new SimpleCource(0, -1, 1, 90);
    ...
    public void testCPA2()
    {
        SimpleCource c1 = new SimpleCource(-1, 0, 1, 0);
        assertEquals(0, c1.getLatitudeAt(HOURS.toMillis(60)), 1e-10);
        SimpleCource c2 = new SimpleCource(0, -1, 2, 90);
    ...
    {
        SimpleCource c = new SimpleCource(0, 0, 1, 0);
    ...
    {
        SimpleCource c = new SimpleCource(0, 0, 1, 90);
