...
public class CoordinateFormatTest
{
    ...
    public void test1()
    {
        ...
        assertEquals("60°30,0000'S", CoordinateFormat.formatLatitude(Locale.forLanguageTag("FI"), -60.5, UnitType.COORDINATE_DEGREES_AND_MINUTES));
        ...
        assertEquals("25°30.0000'E", CoordinateFormat.formatLongitude(Locale.US, 25.5, UnitType.COORDINATE_DEGREES_AND_MINUTES));
